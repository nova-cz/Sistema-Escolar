...
export class FacadeService {
  ...
  saveUserData(user_data: any) {
    ...
    // IMPORTANTE: Priorizar user.id (tabla auth_user) sobre id (tabla maestro/alumno)
    // para maestros y alumnos que tienen estructura {id: <maestro_id>, user: {id: <user_id>, ...}}
    let id = user_data.user?.id || user_data.id;
